/*! grapesjs-plugin-forms - 0.3.3 */ ! function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t(require("grapesjs")) : "function" == typeof define && define.amd ? define(["grapesjs"], t) : "object" == typeof exports ? exports["grapesjs-plugin-forms"] = t(require("grapesjs")) : e["grapesjs-plugin-forms"] = t(e.grapesjs)
}(this, function (e) {
    return function (e) {
        function t(l) {
        ...
        var a = {};
        return t.m = e, t.c = a, t.d = function (e, a, l) {
        ...
        var l = a(1),
            ...
            o = grapesjs || n.default;
        t.default = o.plugins.add("gjs-plugin-forms", function (e, t) {
            var l = t || {},
                n = e.getConfig(),
                o = (n.stylePrefix, {
            ...
            for (var s in o) s in l || (l[s] = o[s]);
            a(2).default(e, l), a(3).default(e, l), a(4).default(e, l)
        })
    }, function (t, a) {
        t.exports = e
    }, function (e, t, a) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                p = {
                    name: "id",
                    label: a.labelTraitId
                },
                u = {
                    name: "for",
                    label: a.labelTraitFor
                },
                b = {
                    name: "name",
                    label: a.labelTraitName
                },
                d = {
                    name: "placeholder",
                    label: a.labelTraitPlaceholder
                },
                g = {
                    name: "value",
                    label: a.labelTraitValue
                },
                m = {
                    type: "checkbox",
                    name: "required",
                    label: a.labelTraitRequired
                },
                h = {
                    label: a.labelTraitChecked,
                    type: "checkbox",
                    name: "checked",
                    changeProp: 1
                };
            l.addType("form", {
                model: s.extend({
                    defaults: Object.assign({}, s.prototype.defaults, {
                        droppable: ":not(form)",
                        draggable: ":not(form)",
                        traits: [{
                            type: "select",
                            label: a.labelTraitMethod,
                            name: "method",
                            options: [{
                                value: "post",
                                name: "POST"
                    ...
                    showState: function (e) {
                        ...
                        var n = this.getStateModel("success"),
                            o = this.getStateModel("error"),
                            s = n.getStyle(),
                            i = o.getStyle();
                        s.display = a, i.display = t, n.setStyle(s), o.setStyle(i)
                    },
                    getStateModel: function (e) {
                        for (var t, a = e || "success", l = this.get("components"), n = 0; n < l.length; n++) {
                            var o = l.models[n];
                ...
                model: s.extend({
                    defaults: Object.assign({}, s.prototype.defaults, {
                        "custom-name": a.labelInputName,
                        tagName: "input",
                        draggable: "form, form *",
                        droppable: !1,
                        traits: [b, d, {
                            label: a.labelTraitType,
                            type: "select",
                            name: "type",
                            options: [{
                                value: "text",
                                name: a.labelTypeText
                            }, {
                                value: "email",
                                name: a.labelTypeEmail
                            }, {
                                value: "password",
                                name: a.labelTypePassword
                            }, {
                                value: "number",
                                name: a.labelTypeNumber
                            }]
                        }, m]
                    })
                }, {
            ...
            var f = l.getType("input"),
                v = f.model;
            l.addType("textarea", {
                model: f.model.extend({
                    defaults: Object.assign({}, v.prototype.defaults, {
                        "custom-name": a.labelTextareaName,
                        tagName: "textarea",
                        traits: [b, d, m]
                    })
                }, {
                ...
                model: s.extend({
                    defaults: Object.assign({}, v.prototype.defaults, {
                        "custom-name": a.labelSelectName,
                        tagName: "select",
                        traits: [b, {
                            label: a.labelTraitOptions,
                            type: "select-options"
                        }, m]
                    })
                }, {
                ...
                model: s.extend({
                    defaults: Object.assign({}, v.prototype.defaults, {
                        "custom-name": a.labelCheckboxName,
                        copyable: !1,
                        attributes: {
                            type: "checkbox"
                        },
                    ...
                    handleChecked: function () {
                        var e = this.get("checked"),
                            ...
                            a = this.view;
                        e ? t.checked = "checked" : delete t.checked, a && (a.el.checked = e), this.set("attributes", Object.assign({}, t))
                    }
                }, {
                    isComponent: function (e) {
            ...
            var y = l.getType("checkbox");
            l.addType("radio", {
                model: y.model.extend({
                    defaults: Object.assign({}, y.model.prototype.defaults, {
                        "custom-name": a.labelRadioName,
                        attributes: {
                            type: "radio"
                        }
                    })
                ...
                model: s.extend({
                    defaults: Object.assign({}, v.prototype.defaults, {
                        ...
                        traits: [{
                            ...
                            options: [{
                                value: "submit",
                                name: a.labelTypeSubmit
                            }, {
                                value: "reset",
                                name: a.labelTypeReset
                            }, {
                                value: "button",
                                name: a.labelTypeButton
                            }]
                        }]
                    })
                }, {
            ...
            t.addType("content", {
                ...
                onValueChange: function () {
                    for (var e = this.model.get("value").trim(), t = e.split("\n"), a = [], l = 0; l < t.length; l++) {
                        ...
                        o[1] ? (s.content = o[1], s.attributes.value = o[0]) : (s.content = o[0], s.attributes.value = o[0]), a.push(s)
                    }
                    this.target.get("components").reset(a), this.target.view.render()
                },
                getInputEl: function () {
                    if (!this.$input) {
                        for (var e = this.model, t = this.target, a = (e.get("name"), ""), l = t.get("components"), n = 0; n < l.length; n++) {
                            var o = l.models[n];
                            a += (o.get("attributes").value || "") + "::" + o.get("content") + "\n"
                        }
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                a = t,
                l = e.BlockManager;
            a.blocks.indexOf("form") >= 0 && l.add("form", {
                label: '\n' +
                    ...
                    '      </svg>\n      ' +
                    '<div class="gjs-block-label">' + a.labelForm + "</div>",
                category: "Forms",
                content: '\n        ' +
                    '<form class="form">\n' +
                    ...
                    '
                    '</form>\n      '
            }), a.blocks.indexOf("input") >= 0 && l.add("input", {
                label: '\n      <svg class="gjs-block-svg" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">\n        ' +
                    '<path class="gjs-block-svg-path" d="M22,9 C22,8.4 21.5,8 20.75,8 L3.25,8 C2.5,8 2,8.4 2,9 L2,15 C2,15.6 2.5,16 3.25,16 L20.75,16 C21.5,16 22,15.6 22,15 L22,9 Z M21,15 L3,15 L3,9 L21,9 L21,15 Z"></path>\n' +
                    '        <polygon class="gjs-block-svg-path" points="4 10 5 10 5 14 4 14"></polygon>\n' +
                    '      </svg>\n' +
                    '      <div class="gjs-block-label">' + a.labelInputName + "</div>",
                category: "Forms",
                content: '<input class="input"/>'
            }), a.blocks.indexOf("textarea") >= 0 && l.add("textarea", {
                label: '\n      <svg class="gjs-block-svg" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">\n        ' +
                    ...
                    '      </svg>\n' +
                    '      <div class="gjs-block-label">' + a.labelTextareaName + "</div>",
                category: "Forms",
                content: '<textarea class="textarea"></textarea>'
            }), a.blocks.indexOf("select") >= 0 && l.add("select", {
                label: '\n      <svg class="gjs-block-svg" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">\n' +
                    ...
                    '      </svg>\n ' +
                    '     <div class="gjs-block-label">' + a.labelSelectName + "</div>",
                category: "Forms",
                content: '<select class="select">\n' +
                    ...
                    "        </select>"
            }), a.blocks.indexOf("button") >= 0 && l.add("button", {
                label: '\n      <svg class="gjs-block-svg" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">\n' +
                    '        <path class="gjs-block-svg-path" d="M22,9 C22,8.4 21.5,8 20.75,8 L3.25,8 C2.5,8 2,8.4 2,9 L2,15 C2,15.6 2.5,16 3.25,16 L20.75,16 C21.5,16 22,15.6 22,15 L22,9 Z M21,15 L3,15 L3,9 L21,9 L21,15 Z" fill-rule="nonzero"></path>\n' +
                    '        <rect class="gjs-block-svg-path" x="4" y="11.5" width="16" height="1"></rect>\n' +
                    '      </svg>\n' +
                    '      <div class="gjs-block-label">' + a.labelButtonName + "</div>",
                category: "Forms",
                content: '<button class="button">Send</button>'
            }), a.blocks.indexOf("label") >= 0 && l.add("label", {
                label: '\n      ' +
                    '      <svg class="gjs-block-svg" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">\n' +
                    ...
                    '      </svg>\n' +
                    '      <div class="gjs-block-label">' + a.labelNameLabel + "</div>",
                category: "Forms",
                content: '<label class="label">Label</label>'
            }), a.blocks.indexOf("checkbox") >= 0 && l.add("checkbox", {
                label: a.labelCheckboxName,
                attributes: {
                    class: "fa fa-check-square"
                },
                category: "Forms",
                content: '<input type="checkbox" class="checkbox"/>'
            }), a.blocks.indexOf("radio") >= 0 && l.add("radio", {
                label: a.labelRadioName,
                attributes: {
